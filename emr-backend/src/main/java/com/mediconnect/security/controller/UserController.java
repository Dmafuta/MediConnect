...
import com.mediconnect.security.dto.UserChangePasswordRequest;
import com.mediconnect.security.dto.UserCreateRequest;
...
public class UserController {
    ...
    public Page<User> getAllUsers(@PageableDefault(size = 15) Pageable pageable) {
